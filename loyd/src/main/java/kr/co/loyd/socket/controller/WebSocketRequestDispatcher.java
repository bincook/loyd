...
import kr.co.loyd.socket.channel.ChannelHandlerInvoker;
import kr.co.loyd.socket.channel.ChannelHandlerResolver;
import kr.co.loyd.socket.channel.SubscriptionHub;
import kr.co.loyd.socket.util.TokenManager;
import kr.co.loyd.socket.message.IncomingMessage;
...
public class WebSocketRequestDispatcher extends TextWebSocketHandler {
    ...
    public void afterConnectionEstablished(WebSocketSession webSocketSession) {
        ...
        try {
            ...
            IpAddress address = tokenManager.verifyJsonWebToken(token);
