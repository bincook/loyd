...
<body>
 ...
 <form method="post" action="insert_ok">
  <input type="hidden" name="watch_id" value="watch_id"> <!--상품 상세의 id값  -->
  <div id="first">
 <div id="left">
...
<div id="right" class="form-group">
  ...
  <table border="1" align="center" class="dot"><tr align="center">
<sapn class="gray3">문의유형 선택!</sapn>
<td ><i class="bi bi-smartwatch"></i><br> 상품<input type="radio" name="qnatype" value="상품"></td>
<td><i class="bi bi-truck"></i><br> 배송<input type="radio" name="qnatype" value=" 배송"></td>
 <td><i class="bi bi-calendar-x-fill"></i><br>반품/취소<input type="radio" name="qnatype" value="반품/취소"></td>
 <td><i class="bi bi-arrow-repeat"></i><br>교환/변경<input type="radio" name="qnatype" value="교환/변경"></td>
<td><i class="bi bi-three-dots"></i><br> 기타<input type="radio" name="qnatype" value="기타"></td>
  </table></tr>
  <br>
 <p>  
 
  <div class="form-group" >
		 	<input class="form-control" type="text" name="title" placeholder="제목"><p>
  </div>
 
  <div class="form-group">
		 <textarea class="form-control" name="content" placeholder="문의유형을 선택 후 궁금하신 내용을 적어주세요" cols="40" rows="5"></textarea>
	</div>       
   ...
   <tr height="50">
	...
	<div id="ctn_show" class="gray3">
	  <div class="form-group" >
	      <input class="form-control"  type="password" name="pwd" placeholder="비밀번호를 입력해주세요" size="30"><br>      
	  </div>    
	...
	<div id="ctn_show2">	 
	  <div class="form-group" >
	    <input  class="form-control"  type="text" name="email" placeholder="답변받을  email주소를 입력해주세요" size="30">    
	</div>     
 		</div>      
 	</div>   
 	</div>
